...
export const navItems: NavItem[] = [
  ...
  },
  {
    ...
    children: [
      {
        displayName: 'Lista de Participantes',
        iconName: 'list',
        route: '/dashboard/participants',
      },
      {
        displayName: 'Nuevo Participante',
        iconName: 'user-plus',
        route: '/dashboard/participants/form',
      },
    ],
  },
  {
    ...
    children: [
      {
        displayName: 'Lista de Asistencias',
        iconName: 'list',
        route: '/dashboard/attendance',
      },
      {
        displayName: 'Nueva Asistencia',
        iconName: 'calendar-plus',
        route: '/dashboard/attendance/form',
      },
    ],
  },
];
